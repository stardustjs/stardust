...
export class Viewport3D extends Viewport {
  constructor(public width: number, public height: number, public fov: number) {
    super();
  }
}

const platformConstructors = new Dictionary<(...args: any[]) => Platform>();
