...
export namespace SyntaxTree {
  ...
  export interface StatementEmit extends Statement {
    type: "emit";
    vertices: Array<{ [name: string]: Expression }>;
  }
  // return statement.
...
interface PEGJSCompiled {
  ...
  ): SyntaxTree.File | SyntaxTree.Expression;
}
const parser_pegjs: PEGJSCompiled = require("./parser_pegjs");
